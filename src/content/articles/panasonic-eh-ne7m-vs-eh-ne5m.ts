...
export const panasonicHairDryerArticle = defineArticleMetadata({
  ...
  leftModel: {
    ...
    line: "EH-NE7M",
    tagline: "Wミネラルなら",
    image: "/products/panasonic-eh-ne7m.png",
    imageAlt: "パナソニック イオニティ EH-NE7M ドライヤー",
    officialHref: "https://panasonic.jp/hair/products/EH-NE7M-W.html",
    guidePoints: ["Wミネラルと低温ケアモードを重視する人の候補"],
  },
  rightModel: {
    brand: "パナソニック",
    line: "EH-NE5M",
    tagline: "大風量・基本機能なら",
    image: "/products/panasonic-eh-ne5m.png",
    imageAlt: "パナソニック イオニティ EH-NE5M ドライヤー",
    officialHref: "https://panasonic.jp/hair/products/EH-NE5M-W.html",
    guidePoints: ["大風量と基本的なヘアケア機能を選びたい人の候補"],
  },
  keyDiffRows: [
    {
      label: "ミネラル機能",
  ...
  summaryParagraph:
    "EH-NE7MはWミネラル＆マイナスイオン、EH-NE5Mはマイナスイオンを公式ページで確認できます。低温ケアモードと大風量・速乾は両モデルで案内されています。価格はどちらもオープン価格です。",
  officialDescription:
  ...
  faqEntries: [
    {
      question: "パナソニック EH-NE7M と EH-NE5M の違いは？",
      answer:
        "公式ページで確認できる主な違いは、EH-NE7MがWミネラル＆マイナスイオンと低温ケアモードを案内しているのに対し、EH-NE5Mはマイナスイオンと低温ケアモードを案内していることです。",
    },
    {
      question: "Wミネラルが搭載されているのはどっち？",
      answer:
        "パナソニック公式ページでは、EH-NE7MにWミネラル＆マイナスイオンが案内されています。EH-NE5Mはマイナスイオンが案内されています。",
    },
    {
      question: "どちらも大風量ですか？",
      answer:
        "両モデルとも、公式ページで大風量・速乾に関する案内があります。風量の具体的な数値や測定条件は、購入時点の各公式仕様ページで確認してください。",
    },
    {
      question: "価格は比較できますか？",
      answer:
        "両モデルとも公式ページではオープン価格として扱われています。価格の優劣は推測せず、Wミネラル、マイナスイオン、低温ケアモードなど公式に確認できる機能で比較しています。",
    },
  ],
  disclaimer:
    "この比較は、パナソニック公式の商品ページで確認できる情報を根拠にしています。個人の感想や口コミは比較の根拠にしていません。",
});
